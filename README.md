...
3. Put one or more mods into the mod directory (NOT the same as the game directory) for your game. This should be `%AppData%/Balatro/Mods` (if you are modding Balatro).
...
3. Put one or more mods into the Mac mod directory (NOT the same as the game directory) for your game. This should be `/Users/$USER/Library/Application Support/Balatro/Mods` where `$USER` is your username (if you are modding Balatro).\
