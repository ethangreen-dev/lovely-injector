...
1. Download the latest release for Windows (located in the right sidebar under Releases). This will be `lovely-x86_64-pc-windows-msvc.zip`.
...
1. Download the latest release for Mac (located in the right sidebar under Releases). If you have an M-series CPU (M1, M2, etc.) then this will be `lovely-aarch64-apple-darwin.tar.gz`. If you have an Intel CPU then it will be `lovely-x86_64-apple-darwin.tar.gz`
